...
description: Parallel Routes allows you to render multiple Nuxt pages within a single route, either synchronously or manually.
---
...
- [Example - News App with Sidebar](https://github.com/serkodev/nuxt-pages-plus/tree/main/examples/parallel-news)
